...
public abstract class WinspoolUtil {
   public static Winspool.PRINTER_INFO_1[] getPrinterInfo1() {
      ...
      Winspool.INSTANCE.EnumPrinters(2, (WString)null, 1, (Pointer)null, 0, pcbNeeded, pcReturned);
      if(pcbNeeded.getValue() <= 0) {
         ...
         if(!Winspool.INSTANCE.EnumPrinters(2, (WString)null, 1, pPrinterEnum.getPointer(), pcbNeeded.getValue(), pcbNeeded, pcReturned)) {
   ...
   public static Winspool.PRINTER_INFO_4[] getPrinterInfo4() {
      IntByReference pcbNeeded = new IntByReference();
      IntByReference pcReturned = new IntByReference();
      Winspool.INSTANCE.EnumPrinters(2, (WString)null, 4, (Pointer)null, 0, pcbNeeded, pcReturned);
      if(pcbNeeded.getValue() <= 0) {
         return new Winspool.PRINTER_INFO_4[0];
      } else {
         Winspool.PRINTER_INFO_4 pPrinterEnum = new Winspool.PRINTER_INFO_4(pcbNeeded.getValue());
         if(!Winspool.INSTANCE.EnumPrinters(2, (WString)null, 4, pPrinterEnum.getPointer(), pcbNeeded.getValue(), pcbNeeded, pcReturned)) {
            throw new Win32Exception(Kernel32.INSTANCE.GetLastError());
         } else {
